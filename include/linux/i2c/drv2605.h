...
** Gpio
*/
#define GPIO_VIBTONE_EN1  PM8921_GPIO_PM_TO_SYS(33)
#define GPIO_VIBTONE_PWM  PM8921_GPIO_PM_TO_SYS(44)  
...
#define DRV2605_ID_0X60 (6 << 4)
#define DRV2605_ID_0XA0 (5 << 5)
#define DRV2604 (4 << 5)
...
#define DEFAULT_LRA_AUTOCAL_BACKEMF         0XDE//0xBB
