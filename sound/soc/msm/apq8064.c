...
//ztemt audio add by zmwu,  use headset detect gpio way instead of the default mbhc way.
...
#ifdef CONFIG_ZTEMT_AUDIO
//ztemt audio add by zmwu 20121010, set detect pin gpio 38 low level trigger, 0(low level) when insert and 1(high level) when remove.
...
//ztemt audio add by zmwu, AMIC3 as handset main mic.  add a wideget. 
	SND_SOC_DAPM_MIC("Analog Mic3", NULL),
//ztemt audio add by zmwu, AMIC4 as handset second mic.  add a wideget. 
...
//#ifndef CONFIG_SND_SOC_DUAL_AMIC
       #ifdef CONFIG_ZTEMT_AUDIO_HANDSET_MIC
	 //ztemt audio add by zmwu 20121010, mainly config mic bias1 pin as handset micbias, and AMIC3 as handset main mic.  
	{"AMIC3", NULL, "MIC BIAS1 External"},
	{"MIC BIAS1 External", NULL, "Analog Mic3"},
	
	//ztemt audio add by zmwu 20121016, mainly config mic bias1 pin as handset micbias, and AMIC4 as handset second mic.  
	{"AMIC4", NULL, "MIC BIAS1 External"},
	{"MIC BIAS1 External", NULL, "Analog Mic4"},
	#else
