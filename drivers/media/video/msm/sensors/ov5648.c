...
static struct msm_camera_i2c_reg_conf ov5648_prev_settings[] = {
 ...
 {0x4005, 0x18}, //add nick
 {0x4050, 0x37}, //add nick
 {0x4051, 0x8f}, //add nick
...
static enum msm_camera_vreg_name_t ov5648_veg_seq[] = {
	CAM_VDIG,
	CAM_VIO,	
};
...
static struct msm_sensor_fn_t ov5648_func_tbl = {
	...
	.sensor_write_exp_gain = ov5648_write_prev_exp_gain,  //Index Tag: ZTEMT_CAMERA_20121126_64xGain
	.sensor_write_snapshot_exp_gain = ov5648_write_pict_exp_gain,	 //Index Tag: ZTEMT_CAMERA_20121126_64xGain
...
static struct msm_sensor_ctrl_t ov5648_s_ctrl = {
	...
	.vreg_seq = ov5648_veg_seq,
	.num_vreg_seq = ARRAY_SIZE(ov5648_veg_seq),
